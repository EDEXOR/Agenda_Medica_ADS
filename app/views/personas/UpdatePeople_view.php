<div class="container">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-sm-12 col-md-6 col-lg-6">
      ...
      <input name="dui" type="text" class="form-control" id="Dui" placeholder="Dui" value="<?php print($object->getDui());?>" required/>
    </div>
    <div class="form-group col-sm-12 col-md-6 col-lg-6">
      <label for="Dui">Fecha nacimiento:</label>
      <input class="form-control" data-date-format="yyyy-mm-dd" id="datepicker" name="fecha" value="<?php print($object->getFecha());?>" required/>
    </div>
  </div>
